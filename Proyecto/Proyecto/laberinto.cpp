...
GLfloat Specular[] = { 0.2, 0.5, 0.2, 1.0 };				// Specular Light Values
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glDisable(GL_TEXTURE_2D);
		renderBitmapCharacter(-11, 10.5, -14, (void *)font, "laberinto");
	glEnable(GL_TEXTURE_2D);
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("laberinto"); // Nombre de la Ventana
